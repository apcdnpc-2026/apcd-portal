...
export default function HomePage() {
  ...
  const faqs = [
    {
      ...
      answer: 'Manufacturers of Air Pollution Control Devices (APCDs) with valid GST registration and manufacturing facilities in India can apply.',
    },
    {
      question: 'What documents are required?',
      answer: 'Company registration certificates, GST registration, manufacturing facility proof, product catalogs, test reports, and quality certifications.',
    },
    {
      question: 'How long does the process take?',
      answer: 'The complete empanelment process typically takes 45-60 working days after submission of complete application.',
    },
    {
      question: 'What is the validity of the certificate?',
      answer: 'The empanelment certificate is valid for 3 years from the date of issuance and can be renewed before expiry.',
    },
  ];
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      {/* Hero Section */}
      <section className="bg-gradient-to-br from-gov-blue to-blue-800 text-white py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-blue-100 mb-8">
              Get your company empaneled as an approved manufacturer of Air Pollution Control Devices
              under the Central Pollution Control Board (CPCB) guidelines.
            </p>
            <div className="flex gap-4">
              <Link href="/register">
                <Button size="lg" className="bg-white text-gov-blue hover:bg-blue-50">
                  Start Application
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="text-center mb-10">
            <h2 className="text-3xl font-bold mb-4">APCD Categories for Empanelment</h2>
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Manufacturers can apply for empanelment in the following Air Pollution Control Device categories
            </p>
          </div>
          <div className="grid md:grid-cols-4 gap-4 max-w-4xl mx-auto">
            {apcdCategories.map((category, index) => (
              <div
                key={index}
                className="flex items-center gap-2 p-4 bg-gray-50 rounded-lg border"
              >
      ...
      <section id="process" className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-10">
            <h2 className="text-3xl font-bold mb-4">Empanelment Process</h2>
            <p className="text-muted-foreground max-w-2xl mx-auto">
                ...
                <CardContent>
                  <ul className="space-y-2">
                    <li className="flex items-start gap-2">
                      ...
                      <span className="text-sm">Certificate of Incorporation / Partnership Deed</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <CheckCircle2 className="h-4 w-4 text-green-500 mt-1 flex-shrink-0" />
              ...
              <Card>
                ...
                <CardContent>
                  <ul className="space-y-2">
                    ...
                    <li className="flex items-start gap-2">
                      <CheckCircle2 className="h-4 w-4 text-green-500 mt-1 flex-shrink-0" />
                      <span className="text-sm">Installation experience proof (3+ installations)</span>
                    </li>
                  </ul>
                </CardContent>
              </Card>
      ...
      <section className="py-16 bg-gov-blue text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-blue-100 mb-8 max-w-2xl mx-auto">
            Register now and begin your APCD OEM empanelment application.
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-8">
            <div>
              ...
              <p className="text-sm text-gray-400">
                The APCD OEM Empanelment Portal is an initiative by the National Productivity Council
                for the Central Pollution Control Board to streamline the empanelment of Air Pollution
                Control Device manufacturers.
              </p>
            </div>
            <div>
